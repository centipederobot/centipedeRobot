<template>
  <div class="d-flex flex-column width-window height-window overflow-hidden" :class="theme.backgroundClass">
    ...
    <div class="d-flex flex-column flex-center gap-4 position-absolute center right">
      <RouterLink style="width: 180px" class="button-style text-center px-6 font-size-5 radius-10 py-2 font-500" :class="[
    ...
    <div class="bottom position-absolute width-full px-4 d-flex flex-space-between">
      <div class="d-flex flex-1 align-center gap-2">
        <button @click="useLanguage.toggleLanguage()"
          ...
          style="width: 40px; height: 40px" :class="theme.colors === 'black' ? 'bg-neutral-400' : 'bg-neutral-200'">
    ...
    <!-- Settings Dialog -->
    <Dialog :model-value="showSettingDialog" :dir="useLanguage.language == 'fa' ? 'rtl' : 'ltr'"
      ...
      <div class="width-full d-flex flex-column gap-4" :class="theme.switchPrimaryClass">
        <div class="d-flex align-center gap-2">
          ...
          <div :class="theme.colors == 'black' && 'text-blue-500'" class="d-flex cursor-pointer align-center gap-1"
            @click="theme.colors = 'black'">
            <Icon icon="solar:moon-stars-bold" width="30" />
            <p>{{ $t('home.dark') }}</p>
          </div>
          <div :class="theme.colors == 'white' && 'text-yellow-500'" class="d-flex cursor-pointer align-center gap-1"
        ...
        <div class="d-flex align-center gap-2">
          ...
          <div :class="theme.colors === 'black' && 'text-red-400'" class="d-flex align-center gap-1">
            <Icon icon="bx:joystick" width="40" />
            <p>{{ $t('home.ps4') }}</p>
          </div>
          <div :class="theme.colors === 'white' && 'text-red-400'" class="d-flex align-center gap-1">
    ...
    <!-- Info Dialog -->
    <Dialog :model-value="showInfoDialog" :dir="useLanguage.language == 'fa' ? 'rtl' : 'ltr'"
    ...
    <!-- Hotspot Dialog -->
    <Dialog :model-value="showHotSpotDialog" :dir="useLanguage.language == 'fa' ? 'rtl' : 'ltr'"
      ...
      <div class="d-flex flex-column gap-4 width-full pa-2" :class="theme.switchPrimaryClass">
        <div v-for="item in 3" :key="item" class="width-full d-flex flex-space-between gap-4 px-2 py-2 radius-2"
          ...
          <div class="d-flex flex-space-between gap-2">
            <button class="button-style-success px-4 py-2 radius-2 d-flex flex-center gap-1 border-none outline-none"
