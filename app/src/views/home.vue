<template>
    <div class="d-flex flex-column width-window height-window overflow-hidden" :class="theme.backgroundClass">
        ...
        <div class="d-flex flex-column flex-center gap-4 position-absolute center right">
            <RouterLink style="width: 180px;" class="button-style text-center px-6 font-size-5 radius-10 py-2 font-500"
                :class="[theme.switchPrimaryClass, theme.colors === 'black' ? 'bg-neutral-500' : 'bg-neutral-200']"
                to="/aiMode">
                {{ $t('home.aiMode') }}
            </RouterLink>
        ...
        <Dialog :model-value="showSettingDialog" :dir="useLanguage.language == 'fa' ? 'rtl' : 'ltr'"
            ...
            <div class="width-full d-flex flex-column gap-4" :class="theme.switchPrimaryClass">
                <div class="d-flex align-center gap-2">
                    ...
                    <div :class="theme.colors == 'black' && 'text-blue-500'"
                        class="d-flex cursor-pointer align-center gap-1" @click="theme.colors = 'black'">
                        <Icon icon="solar:moon-stars-bold" width="30" />
                        <p>{{ $t('home.dark') }}</p>
                    </div>
                    <div :class="theme.colors == 'white' && 'text-yellow-500'"
                        class="d-flex cursor-pointer align-center gap-1" @click="theme.colors = 'white'">
                ...
                <div class="d-flex align-center gap-2">
                    ...
                    <div class="d-flex cursor-pointer align-center text-red-400 gap-1">
                        <Icon icon="bx:joystick" width="40" />
                        <p>{{ $t('home.ps4') }}</p>
                    </div>
                    <div class="d-flex cursor-pointer align-center gap-1">
                ...
                <div v-for="item in 3" :key="item" class="width-full d-flex flex-space-between gap-4 px-2 py-2 radius-2"
                    ...
                    <div class="d-flex flex-space-between gap-2">
                        <button
                            ...
                            :class="theme.colors === 'black' ? 'bg-emerald-500 text-white' : 'bg-emerald-300 text-black'">
                            {{ $t('home.connect') }}
